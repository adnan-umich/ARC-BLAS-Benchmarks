...
program_main ()
{
    ...
    if ( true )
    {
        ...
        if ( true )
        {
            ...
            auto  [ rowcbL, colcbL, L2 ] = impl::matrix::build_uniform_rec( *L, apx, acc, cmdline::compress );
            auto  [ rowcbU, colcbU, U2 ] = impl::matrix::build_uniform_rec( *U, apx, acc, cmdline::compress );
